...
### Print-on-Demand Mockup Workflow (Etsy / Printify)

For physical POD products — apparel, mugs, totes, phone cases — AI generation produces unusable results. Use real mockup tools.

**Etsy listing image requirements:**
- Minimum 2000px on shortest side (square or 4:3 recommended)
- Maximum 100MB per image
- Up to 10 images per listing
- First image is the only one shown in Etsy search results — it carries the most weight
- Show the product in use; flat-on-white alone underperforms lifestyle shots

**Mockup tool options:**

| Tool | Cost | Best For |
|------|------|----------|
| **Printify native mockup generator** | Free (included) | Fast base mockups for any Printify product |
| **Placeit** | ~$15/mo or per image | Lifestyle mockups with real models and real settings |
| **Smartmockups** | Free tier / ~$9/mo | Flat and angled product shots, batch export |
| **Canva** | Free / Pro | Text overlays, seasonal banners, variant grids over mockups |

**Standard workflow for Etsy listings:**
1. Generate the product in Printify and download the base mockup at highest available resolution
2. For lifestyle context: upload to Placeit or Smartmockups, select a scene, export at 2000px minimum
3. Open in Canva to add any text overlay — product name, seasonal callout, size reminder
4. Export at minimum 2000x2000px
5. Arrange images: first = lifestyle/in-use, second = flat or detail, third = size chart or variant grid, fourth+ = additional angles or use cases

**Image count strategy per listing:**
- 5 images minimum — Etsy's algorithm favors listings with more images
- 10 images is the limit — use all 10 for top-selling listings
- Include at least one size chart image for any apparel listing
